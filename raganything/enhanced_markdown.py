...
class EnhancedMarkdownConverter:
    ...
    def convert_with_pandoc(self, markdown_content: str, output_path: str, use_system_pandoc: bool = False) -> bool:
        ...
        if not self.available_backends.get("pandoc_system", False) and not use_system_pandoc:
            raise RuntimeError("Pandoc not available. Install from: https://pandoc.org/installing.html")
    ...
    def convert_markdown_to_pdf(
        ...
        try:
            if method == "weasyprint":
                ...
                return self.convert_with_pandoc(markdown_content, output_path, use_system_pandoc=True)
            else:
    ...
    def convert_file_to_pdf(
        ...
        try:
            ...
            for encoding in ['gbk', 'latin-1', 'cp1252']:
                ...
                raise RuntimeError(f"Could not decode file {input_path} with any supported encoding")
...
def main():
    ...
    parser.add_argument("--method", choices=["auto", "weasyprint", "pandoc", "pandoc_system"], default="auto", help="Conversion method")
